...
pub const BuiltinsInstanceDef = struct {
    ...
    /// Initializes a new `BuiltinsInstanceDef` structure representing the 'dex' layout.
    ///
    /// Enabling Pedersen, Range Check, and ECDSA instances.
    pub fn dex() Self {
        return .{
            .output = true,
            .pedersen = PedersenInstanceDef.init(),
    ...
    /// Represents the 'recursive' layout in Cairo, designed for a verification proof with cryptographic and validation tasks.
    pub fn recursive() Self {
        return .{
            .output = true,
            .pedersen = PedersenInstanceDef.from(128, 1),
            .range_check = RangeCheckInstanceDef.init(),
            .ecdsa = null,
            .bitwise = BitwiseInstanceDef.from(8),
            .ec_op = null,
            .keccak = null,
            .poseidon = null,
        };
    ...
    /// Represents the 'starknet' layout.
    ///
    /// Tailored for StarkNet applications involving various cryptographic operations and validation tasks.
    pub fn starknet() Self {
        return .{
            .output = true,
            .pedersen = PedersenInstanceDef.from(32, 1),
            .range_check = RangeCheckInstanceDef.from(16, 8),
    ...
    /// Represents the 'starknetWithKeccak' layout.
    ///
    /// Tailored for StarkNet applications with Keccak hashing.
    pub fn starknetWithKeccak(allocator: Allocator) !Self {
    ...
    /// Represents the 'recursiveLargeOutput' layout.
    ///
    /// Optimized for extensive bitwise and Pedersen instances.
    ...
    /// Initializes a new `BuiltinsInstanceDef` structure representing the 'allSolidity' layout optimized for Solidity contracts.
    pub fn allSolidity() Self {
        return .{
            ...
            .range_check = RangeCheckInstanceDef.init(),
            .ecdsa = EcdsaInstanceDef.init(),
            .bitwise = BitwiseInstanceDef.init(),
            .ec_op = EcOpInstanceDef.init(),
            .keccak = null,
            .poseidon = null,
        };
    }
...
test "BuiltinsInstanceDef: builtins dex" {
    try expectEqual(
        BuiltinsInstanceDef{
            .output = true,
            .pedersen = .{
        ...
        BuiltinsInstanceDef.dex(),
    );
}

test "BuiltinsInstanceDef: builtins recursive" {
    try expectEqual(
        BuiltinsInstanceDef{
            .output = true,
            .pedersen = .{
        ...
        BuiltinsInstanceDef.recursive(),
    );
}

test "BuiltinsInstanceDef: builtins starknet" {
    try expectEqual(
        BuiltinsInstanceDef{
            .output = true,
            .pedersen = .{
...
test "BuiltinsInstanceDef: builtins starknet with keccak" {
    var actual = try BuiltinsInstanceDef.starknetWithKeccak(std.testing.allocator);
    defer actual.deinit();
...
test "BuiltinsInstanceDef: builtins recursive large output" {
    try expectEqual(
        BuiltinsInstanceDef{
            .output = true,
            .pedersen = .{
        ...
        BuiltinsInstanceDef.recursiveLargeOutput(),
    );
}
...
test "BuiltinsInstanceDef: builtins all Solidity" {
    try expectEqual(
        BuiltinsInstanceDef{
            .output = true,
            .pedersen = .{
        ...
        BuiltinsInstanceDef.allSolidity(),
    );
}
