...
test "Felt252: fromSigned and toSigned" {
    try expectEqual(Felt252.zero().sub(Felt252.one()), Felt252.fromSignedInt(u8, false, 1));

    try expectEqual(Felt252.fromInt(u32, 250), Felt252.fromSignedInt(u8, false, 250).neg());

    try expectEqual(Felt252.fromInt(u256, std.math.maxInt(i256)), Felt252.fromSignedInt(u256, true, std.math.maxInt(i256)));

    const maxSignedNeg = Felt252.fromSignedInt(i256, false, std.math.maxInt(i256) - 1).toSignedInt();
