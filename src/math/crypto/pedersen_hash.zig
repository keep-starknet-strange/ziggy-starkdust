...
test "pedersen_p" {
    try expectEqual(Felt252.fromInteger(0x73b3ec210cccbb970f80c6826fb1c40ae9f487617696234ff147451405c339f), pedersenHash(Felt252.fromInteger(0x20), Felt252.fromInteger(0x48)));
    ...
    try expectEqual(Felt252.fromInteger(0x73b3ec210cccbb970f80c6826fb1c40ae9f487617696234ff147451405c339f), pedersenHash(Felt252.fromInteger(32), Felt252.fromInteger(72)));
